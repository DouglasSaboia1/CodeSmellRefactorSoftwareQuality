...
public class StudyPlan extends Registry {
    ...
    public String toString() {
        String objectiveDesc = (objective != null) ? objective.toString() : "No objective";
    ...
    public void assignSteps(List<String> stringProperties, Integer numberOfSteps, boolean isImportant, LocalDateTime startDate, LocalDateTime endDate) {
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd-MM-yyyy HH:mm:ss");

        // Espera que stringProperties tenha exatamente 9 itens (conforme o código original)
    ...
    // Agora handleAssignSteps chama o novo assignSteps simplificado
